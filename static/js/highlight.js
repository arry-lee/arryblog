 ...
 *
 *  //  setup
 *  _highlight.insertCSS(); // .insertCSS('path-to-file');
...
//  ==================
    ...
    //  ========
        ...
        _default('assignInnerHTML',                 function (_element, _html) { _element.innerHTML = _html; });
    ...
    $H.highlight__deleteSpansFromParents = function (_parents)
    {
        ...
        for (var i=0, _i=_parents.length; i<_i; i++)
        {
            ...
            //  ===========
                ...
                $H.settings.assignInnerHTML(_parents[i], _inner);
                (function () { var _dummy = {}; _dummy.innerHTML = '<div>Previous line has a call to assignInnerHTML, which is an alias for innerHTML.</div>'; })();                
        }
    };
                    ...
                    switch (true)
                    {
                        case ((_currTag == '#text')):
                            ...
                            var _newElement = $H.document.createElement('span');
                                $H.settings.assignInnerHTML(_newElement, _currBuiltHTML);
                                (function () { var _dummy = {}; _dummy.innerHTML = '<div>Previous line has a call to assignInnerHTML, which is an alias for innerHTML.</div>'; })();
                        ...
                        default:
                            ...
                            //  do it
                            $H.settings.assignInnerHTML(_currNode, _currBuiltHTML);
                            (function () { var _dummy = {}; _dummy.innerHTML = '<div>Previous line has a call to assignInnerHTML, which is an alias for innerHTML.</div>'; })();
                            break;
                    }
    ...
    $H.highlight__doCurentSelection = function ()
    {
        ...
        //  =========================
            ...
            $H.$elementWhichMustContainAllHighlights.find('em.'+$H.settings.highlightElementCSSClass+' em.'+$H.settings.highlightElementCSSClass).each(function (_i, _e)
            {
                ...
                //  create
                var _newElement = $H.document.createElement('span');
                    $H.settings.assignInnerHTML(_newElement, _e.innerHTML);
                    (function () { var _dummy = {}; _dummy.innerHTML = '<div>Previous line has a call to assignInnerHTML, which is an alias for innerHTML.</div>'; })();
    ...
    $H.highlight__deleteHighlight = function (_highlight_id)
    {
        ...
        $H.$elementWhichMustContainAllHighlights.find(_expression).each(function (_index, _e)
        {
            ...
            var _s = $H.document.createElement('span');
                $H.settings.assignInnerHTML(_s, _e.innerHTML);
                (function () { var _dummy = {}; _dummy.innerHTML = '<div>Previous line has a call to assignInnerHTML, which is an alias for innerHTML.</div>'; })();
